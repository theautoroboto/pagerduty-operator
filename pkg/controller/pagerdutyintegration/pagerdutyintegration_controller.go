...
func (r *ReconcilePagerDutyIntegration) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	r.reqLogger = log.WithValues("IsThisIt.Request.Namespace", request.Namespace, "Request.Name", request.Name, "ClusterDeployment Namespace request.NamespacedName.Namespace", request.NamespacedName.Namespace)
